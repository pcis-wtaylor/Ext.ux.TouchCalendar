...
Ext.define('Ext.ux.TouchCalendarView', {
  ...
  /**
   * Gets a random int in the provided range (inclusive)
   * @param min
   * @param max
   */
  ...
  refreshDelta: function(delta) {
    ...
    newDate.setHours(this.randomInt(0,23));
    newDate.setMinutes(this.randomInt(0,59));
    newDate.setSeconds(this.randomInt(0,59));
